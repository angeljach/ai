...
/**
 * Class _EffortDocuments was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _EffortDocuments extends CayenneDataObject {
    ...
    public static final String TO_AUDIT_JOBS_PROPERTY = "toAuditJobs";
    ...
    public void setToAuditJobs(AuditJobs toAuditJobs) {
        setToOneTarget("toAuditJobs", toAuditJobs, true);
    }

    public AuditJobs getToAuditJobs() {
        return (AuditJobs)readProperty("toAuditJobs");
    }
